...
for (int i = 0; i < quantidade; i++)
{
    ...
    {
        Console.WriteLine("Entrada inválida. Informe um número inteiro maior ou igual a zero para os pontos de saúde:");
    }
}
...
{
    Console.WriteLine($"- {jogador} --- {pontosMana} --- {pontosSaude}");
}
...
switch(Console.ReadLine()?.ToUpper())
{
    case "S":
        ...
        break;
    case "N":
        Console.WriteLine("Eita... Reinicia o sistema e preenche direito seu burro");
        break;
    default:
...
while (true)
{
    switch (Console.ReadLine()?.ToUpper())
    {
        case "S":
            ...
            {
                Console.WriteLine("Personagem não encontrado. Tente novamente.");
                continue;
            }
            ...
            break;
        case "N":
            Console.WriteLine("Encerrando alterações.");
            return;
        default:
